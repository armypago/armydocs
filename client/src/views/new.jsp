	...
	<section id="wrapper">
		...
		<section class="container main">	
			<div class="container_inner">	
								...
								<div class="banner-wrapper">
									<div class="in">
										<div class="centerbox"> 										
											...
											<div class="bn-btn-wrap">
												<a class="comm-btn-style black" onclick="getInfo()">아미독스 설명서 다운로드</a>
											</div> 
										</div> 
									</div>      
								</div>
				...
				<!-- #####################################################################[레이어2] -->
				<div class="layer add-layer2" id="counting" style="border-top: 1px solid #E7E8EF;">
					<div class="inner">	
		...
		<footer class="footer">
		    <div class="corps">   	
		     ...
		     <div class="inner">
		        ...
		        <div>
		            <p class="desc">ARMYDOCS 2019 ⓒ All Rights Reserved.</p>
		        </div>
		    </div>
		</footer>
		<!-- #####################################################################[하단 끝] -->

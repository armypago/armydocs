							...
							<div class="acc-box-wrapper v2">
								<form id="userVo" name="userVo" action="#" method="post" onsubmit="return joinFunc();">
									...
									<div class="headline">
										...
										<a class="sub" href="02.html">로그인</a>     
									</div>
									...
									<div class="clearfix">
										<div class="fl">
											...
											<div class="field-row">
												<input name="id" id="id" autocomplete="off" type="text" class="input-style1" placeholder="군번(아이디)" value="19-76039568"/>
											</div>	
											<div class="field-row">
												<input name="password" id="pw" autocomplete="off" type="password" class="input-style1" placeholder="비밀번호 (영문/숫자 조합, 8자~16자)" value="test1234"/>
											</div>	  
											<div class="field-row">
												<input id="pw2" autocomplete="off" type="password" class="input-style1" placeholder="비밀번호 확인" value="test1234"/>
											</div>	
											
											<div class="field-row">
												<input name="name" id="name" autocomplete="off" type="text" class="input-style1" placeholder="이름" value="정희성"/>
											</div>	
											
											<div class="field-row">
												<input name="email" id="email" autocomplete="off" type="text" class="input-style1" placeholder="이메일" value="qlcskfgml78@naver.com"/>
											</div>
											<div class="field-row">
												<input name="phonenm" id="phonenm" autocomplete="off" type="text" class="input-style1" placeholder="핸드폰번호" value="010-3275-1025"/>
											</div>
										...
										<div class="fr">
											...
											<div class="field-row">
												<input name="recruitDate" id="recruitDate" autocomplete="off" type="text" class="input-style1" placeholder="입대일" value="20191010"/>
											</div>
											<div class="field-row">
												<input name="station" id="station" autocomplete="off" type="text" class="input-style1" placeholder="소속부대" value="계근지단 관리대대"/>
											</div>
											...
											<div class="field-row empty-border-box">
												<div class="ebb-row">
													...
													<label for="terms_1" style="margin-left: 30px;"><a class="underline" target="_blank" href="#">서비스 이용약관</a>에 동의합니다.</label>
												</div>
												<div class="ebb-row">
													<input class="policy-chbox" name="terms_2" type="checkbox" id="terms_2" name="radio-group">
													<label for="terms_2" style="margin-left: 30px;"><a class="underline" target="_blank" href="#">개인정보 수집 및 이용약관</a>에 동의합니다.</label>
												</div> 
												<div class="ebb-row">
